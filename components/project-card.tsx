          ...
          <div className="p-4">
            ...
            {project.collectionId && (() => {
              ...
              <button
                ...
                className={`mb-3 px-2.5 py-0.5 rounded-full text-xs text-zinc-400 bg-white/[0.03] border border-white/[0.06] ${accent.text} ${accent.bg} ${accent.border} transition-colors duration-150`}
              >
